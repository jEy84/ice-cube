...
// const iname  = "";
  ...
  const fetchDetailss = async ( )=>{
    const response = await fetch(`https://api.spoonacular.com/recipes/${params.name}/information?apiKey=596d509027a048f3bc79f7297e38cc62`);
    ...
    <DetailWrapper>
      ...
      <Info>
        ...
        { activeTab === "instructions" && (
           <Details>
           <h3 dangerouslySetInnerHTML={{__html:information.summary}} >
           </h3>
